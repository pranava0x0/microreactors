...
FILES = ["opportunities", "vendors", "costs", "benchmarks", "sectors", "mechanisms", "policy",
         "instruments", "deployment_sites", "voices", "arguments", "gaps"]

# Datasets pulled out of the main bundle and fetched when their tab opens.
# Chosen by two tests, not by size alone: each is read by exactly one panel, and
# nothing computed at boot touches it. `benchmarks` is bigger than `voices` and
# stays eager because two live tabs read it (Costs and Applications), and a
...
CITE_ORDER = ["opportunities", "costs", "benchmarks", "vendors", "sectors", "mechanisms",
              "policy", "instruments", "deployment_sites", "voices", "arguments", "gaps"]
