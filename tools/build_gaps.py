...
def main():
    ...
    out = {
        ...
        "next_pass": [
            ...
            {
                "target": "Operating staff and O&M cost",
                "why": "No tracker or vendor row carries an operator headcount, a staffing plan or an O&M figure from a vendor or a site; the only staffing figures on the site are Idaho National Laboratory's modeled ones, on Costs > What wins.",
                "where": "NRC staffing-exemption requests and 10 CFR 50.54(m) relief filings in ADAMS; DOE DOME experiment operating plans; vendor licensing-topical reports on autonomous and remotely monitored operation.",
                "why_search_failed": "Not searched for in any pass to date. The case for a 1-20 MW unit rests on it not needing a 24/7 licensed crew, so an unstaffed cost line is a hole in the economics, not a missing detail.",
            },
            {
